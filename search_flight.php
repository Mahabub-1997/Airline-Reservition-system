...
<form action="record.php"method="post">
  <div class="container">
    ...
    <input type="radio" name="airline" value="BBC" checked>Biman Bangladesh Airlines (Ban)<br>
  <input type="radio" name="airline" value="BEA"> US Bangla Airlines(BAN)<br>
  <input type="radio" name="airline" value="RGE"> Regent Airways<br>
  <input type="radio" name="airline" value="NVQ"> NovoAir<br>
    ...
    <button type="submit" class="registerbtn">Search Flight</button>
  </div>
