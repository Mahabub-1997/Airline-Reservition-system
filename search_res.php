...
$sql = "SELECT distinct f.airline_ID, fp.flight_no, ts.dateF, fp.src_ID, fp.dst_ID, ts.dep_time, td.arv_time, stockE, stockB from flight f, fl_pair fp, t_src ts, t_dst td where f.flight_no=fp.flight_no and fp.src_id=ts.src_ID and fp.dst_ID=td.dst_ID and ts.ticket_ID=td.ticket_ID and fp.src_ID='$src' and fp.dst_ID='$dst' and ts.dateF='$date'";
...
<br>
<h2>Select the flight of your choice</h2>
<div>
  <form action="book_details.php" method="post">
     <label for="flight">Flight No</label>
    <input type="text" id="flight" name="flight" placeholder="Flight_no">
